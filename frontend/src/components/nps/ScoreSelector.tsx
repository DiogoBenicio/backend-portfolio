...
function getScoreStyle(score: number, selected: number | null) {
  ...
  if (score <= 6)
    return cn(
      ...
      isSelected &&
        'bg-red-500 text-white border-red-500 dark:bg-red-600 dark:border-red-600 dark:text-white'
    )
  if (score <= 8)
    return cn(
      ...
      isSelected &&
        'bg-yellow-500 text-white border-yellow-500 dark:bg-yellow-600 dark:border-yellow-600 dark:text-white'
    )
  return cn(
    ...
    isSelected &&
      'bg-green-500 text-white border-green-500 dark:bg-green-600 dark:border-green-600 dark:text-white'
  )
}
